...
var t$1, o$1, n$2;
var init_node_fetch_native_DfbY2q_x = __esmMin((() => {
	t$1 = Object.defineProperty;
	o$1 = (e, l) => t$1(e, "name", {
		value: l,
		configurable: !0
	});
	n$2 = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
...
var B, E, D, t, w, R$1, g, N, x, P, C, I, M, $$1, m, F$1, k;
var init_multipart_parser = __esmMin((() => {
	...
	R$1 = {
		PART_BOUNDARY: w,
		LAST_BOUNDARY: w *= 2
	}, g = 10, N = 13, x = 32, P = 45, C = 58, I = 97, M = 122, $$1 = E((u) => u | 32, "lower"), m = E(() => {}, "noop"), F$1 = class F {
		constructor(a) {
		...
		write(a) {
			...
			for (n = 0; n < r; n++) switch (o = a[n], i) {
				case t.START_BOUNDARY:
					if (e === c.length - 2) {
						if (o === P) A |= R$1.LAST_BOUNDARY;
						else if (o !== N) return;
						e++;
						break;
					} else if (e - 1 === c.length - 2) {
						if (A & R$1.LAST_BOUNDARY && o === P) i = t.END, A = 0;
						else if (!(A & R$1.LAST_BOUNDARY) && o === g) e = 0, T("onPartBegin"), i = t.HEADER_FIELD_START;
						else return;
						break;
					}
				...
				case t.PART_DATA:
					...
					else if (e === c.length) e++, o === N ? A |= R$1.PART_BOUNDARY : o === P ? A |= R$1.LAST_BOUNDARY : e = 0;
					else if (e - 1 === c.length) if (A & R$1.PART_BOUNDARY) {
						if (e = 0, o === g) {
							A &= ~R$1.PART_BOUNDARY, T("onPartEnd"), T("onPartBegin"), i = t.HEADER_FIELD_START;
							break;
						}
					} else A & R$1.LAST_BOUNDARY && o === P ? (T("onPartEnd"), i = t.END, A = 0) : e = 0;
					if (e > 0) l[e - 1] = o;
					else if (d > 0) {
...
var Os, fi, n$1, ci, O, be, X, ve, zt, bt, Cr, ze, It, Ft, mt, ee, yt, He, Ve, gt, pi, kt, xs, bi, mi, yi, gi, ut, qn, Wt, Qs, Ys, _i, Gs, Si, On, Ue, br, Un, ft, xn, G, mr, wi, yr, Ks, Js, Xs, el, H, Nn, xe, In, tl, Ri, rl, nl, gr, Fn, Pr, ye, il, jn, se, Ne, le, al, Ci, sl, $, qt, dl, vr, dt, hl, Hn, _r, Ln, Pi, ml, $n, vi, Ei, Er, Sr, wl, Bi, Dn, zi, Ii, Fi, wr, Vn, pt, Tr, Mn, $i, ql, Ol, Mi;
var init_node = __esmMin((() => {
	...
	ci = (i, o, a) => o.has(i) || fi("Cannot " + a);
	O = (i, o, a) => (ci(i, o, "read from private field"), a ? a.call(i) : o.get(i)), be = (i, o, a) => o.has(i) ? fi("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(i) : o.set(i, a), X = (i, o, a, f) => (ci(i, o, "write to private field"), f ? f.call(i, a) : o.set(i, a), a);
	...
	({toStringTag: Wt, iterator: Qs, hasInstance: Ys} = Symbol), _i = Math.random, Gs = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), Si = n$1((i, o, a) => (i += "", /^(Blob|File)$/.test(o && o[Wt]) ? [(a = a !== void 0 ? a + "" : o[Wt] == "File" ? o.name : "blob", i), o.name !== a || o[Wt] == "blob" ? new qn([o], a, o) : o] : [i, o + ""]), "f"), On = n$1((i, o) => (o ? i : i.replace(/\r?\n|\r/g, `\r
`)).replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), "e$1"), Ue = n$1((i, o, a) => {
	...
	n$1(xn, "FetchError");
	G = xn;
	mr = Symbol.toStringTag, wi = n$1((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n$1((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n$1((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n$1((i, o) => {
	...
	il = /* @__PURE__ */ new Set([
		...
		307,
		308
	]), jn = n$1((i) => il.has(i), "isRedirect"), se = Symbol("Response internals"), Ne = class Ne extends xe {
	...
	$ = Symbol("Request internals"), qt = n$1((i) => typeof i == "object" && typeof i[$] == "object", "isRequest"), dl = deprecate(() => {}, ".data is not a valid RequestInit property, use .body instead", "https://github.com/node-fetch/node-fetch/issues/1000 (request)"), vr = class vr extends xe {
		constructor(o, a = {}) {
			let f;
	...
	ml = f(pl()), {stat: $n} = promises$1, n$1((i, o) => vi(statSync(i), i, o), "blobFromSync"), n$1((i, o) => $n(i).then((a) => vi(a, i, o)), "blobFrom"), n$1((i, o) => $n(i).then((a) => Ei(a, i, o)), "fileFrom"), n$1((i, o) => Ei(statSync(i), i, o), "fileFromSync"), vi = n$1((i, o, a = "") => new ut([new Sr({
		path: o,
		size: i.size,
	...
	Bi = /* @__PURE__ */ new WeakMap(), Dn = /* @__PURE__ */ new WeakMap();
	n$1(W, "pd");
	...
	zi = /* @__PURE__ */ new WeakMap(), Ii = 1, Fi = 2, wr = 3;
	n$1(Rr, "isObject");
	n$1(Ot, "getListeners");
	...
	ql = Object.defineProperty, Ol = n$1((i, o) => ql(i, "name", {
		value: o,
		configurable: !0
	}), "e");
	Mi = Ai;
...
function parseJsonObject(value, name) {
	...
	if (typeof parsed !== "object" || parsed === null || Array.isArray(parsed)) throw new Error(`Expected a JSON object for "${name}"`);
	return parsed;
}
function parseFiles(value) {
	...
	const result = {};
	for (const [key, val] of Object.entries(obj)) if (typeof val === "string") result[key] = val;
	else if (Array.isArray(val) && val.every((p) => typeof p === "string")) result[key] = val;
	else throw new Error(`Invalid "files" entry "${key}": expected a path string or array of path strings`);
	return result;
}
	...
	if (inputs.files) {
		...
		if (inputs.body) {
			...
			try {
				...
				if (parsed === null || Array.isArray(parsed) || typeof parsed !== "object") throw new Error(badBodyMsg);
				fields = parsed;
			} catch (err) {
			...
			for (const [key, value] of Object.entries(fields)) {
				if (typeof value !== "string" && typeof value !== "number" && typeof value !== "boolean") throw new Error(`"body" field "${key}" must be a scalar value when "files" is set`);
...
async function buildRequest(inputs) {
	...
	else if (inputs.username && inputs.password) headers["authorization"] = `Basic ${Buffer$1.from(`${inputs.username}:${inputs.password}`).toString("base64")}`;
	const options = {
	...
	try {
		...
		try {
			...
			if (fetchError.response) {
				...
				await emitResponse(core, inputs, status, headersToObject(fetchError.response.headers), fetchError.data ?? fetchError.response._data);
