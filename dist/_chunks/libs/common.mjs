...
import { createReadStream, promises as promises$1, statSync } from "node:fs";
...
var require_webidl = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  webidl.converters.ArrayBuffer = function (V, prefix, argument, opts) {
    if (webidl.util.Type(V) !== "Object" || !types$4.isAnyArrayBuffer(V))
      throw webidl.errors.conversionFailed({
        prefix,
        argument: `${argument} ("${webidl.util.Stringify(V)}")`,
        types: ["ArrayBuffer"],
      });
    if (opts?.allowShared === false && types$4.isSharedArrayBuffer(V))
      throw webidl.errors.exception({
        header: "ArrayBuffer",
  ...
  webidl.converters.TypedArray = function (V, T, prefix, name, opts) {
    ...
    if (opts?.allowShared === false && types$4.isSharedArrayBuffer(V.buffer))
      throw webidl.errors.exception({
        header: "ArrayBuffer",
        message: "SharedArrayBuffer is not allowed.",
      });
  ...
  webidl.converters.DataView = function (V, prefix, name, opts) {
    if (webidl.util.Type(V) !== "Object" || !types$4.isDataView(V))
      throw webidl.errors.exception({
        header: prefix,
...
var require_util$6 = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const { collectASequenceOfCodePoints, collectAnHTTPQuotedString, removeChars, parseMIMEType } =
    require_data_url();
  const { performance: performance$1 } = __require("node:perf_hooks");
  const { isBlobLike, ReadableStreamFrom, isValidHTTPToken, normalizedMethodRecordsBase } =
    require_util$7();
  ...
  function bytesMatch(bytes, metadataList) {
    ...
    const metadata = filterMetadataListByAlgorithm(
      parsedMetadata,
      getStrongestMetadata(parsedMetadata),
    );
...
var require_formdata = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  var FormData = class FormData {
    ...
    append(name, value, filename = void 0) {
      ...
      filename =
        arguments.length === 3 ? webidl.converters.USVString(filename, prefix, "filename") : void 0;
...
var require_formdata_parser = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function bufferStartsWith(buffer, start, position) {
    ...
    for (let i = 0; i < start.length; i++)
      if (start[i] !== buffer[position.position + i]) return false;
    return true;
  }
  module.exports = {
        ...
        if (request) {
          ...
          if (
            ...
            (util.isStream(request.body) ||
              ...
              util.isFormDataLike(request.body))
          )
            return true;
        }
        return false;
...
var require_client_h2 = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function parseH2Headers(headers) {
    ...
    for (const [name, value] of Object.entries(headers))
      if (Array.isArray(value))
        for (const subvalue of value) result.push(Buffer.from(name), Buffer.from(subvalue));
  ...
  async function connectH2(client, socket) {
    ...
    util.addListener(session, "close", function () {
      ...
      const err =
        this[kSocket][kError] ||
        this[kError] ||
        new SocketError("closed", util.getSocketInfo(socket));
  ...
  function writeH2(client, request) {
    ...
    for (let n = 0; n < reqHeaders.length; n += 2) {
      ...
      if (Array.isArray(val))
        for (let i = 0; i < val.length; i++)
          if (headers[key]) headers[key] += `,${val[i]}`;
...
var require_proxy_agent = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const Pool = require_pool();
  const DispatcherBase = require_dispatcher_base();
  const { InvalidArgumentError, RequestAbortedError, SecureProxyConnectionError } =
    require_errors();
  const buildConnector = require_connect();
  const Client = require_client();
...
var require_readable = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const { RequestAbortedError, NotSupportedError, InvalidArgumentError, AbortError } =
    require_errors();
  const util = require_util$7();
...
var require_api_stream = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  var StreamHandler = class extends AsyncResource$3 {
    ...
    onHeaders(statusCode, rawHeaders, resume, statusMessage) {
      ...
      let res;
      if (this.throwOnError && statusCode >= 400) {
        const contentType = (responseHeaders === "raw" ? util.parseHeaders(rawHeaders) : headers)[
          "content-type"
        ];
      ...
      return (
        (res.writableNeedDrain !== void 0
          ...
          : res._writableState?.needDrain) !== true
      );
    }
    onData(chunk) {
      const { res } = this;
...
var require_api_pipeline = /* @__PURE__ */ __commonJSMin((exports, module) => {
  const { Readable: Readable$1, Duplex, PassThrough: PassThrough$1 } = __require("node:stream");
...
var require_mock_utils = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function matchHeaders(mockDispatch, headers) {
    ...
    for (const [matchHeaderName, matchHeaderValue] of Object.entries(mockDispatch.headers))
      if (!matchValue(matchHeaderValue, getHeaderByName(headers, matchHeaderName))) return false;
    return true;
  }
  ...
  function generateKeyValues(data) {
    ...
    for (let i = 0; i < keys.length; ++i) {
      ...
      if (Array.isArray(value))
        for (let j = 0; j < value.length; ++j) result.push(name, Buffer.from(`${value[j]}`));
    ...
    reply(replyOptionsCallbackOrStatusCode) {
      if (typeof replyOptionsCallbackOrStatusCode === "function") {
        ...
        return new MockScope(
          addMockDispatch(this[kDispatches], this[kDispatchKey], wrappedDefaultsCallback),
        );
      }
      const replyParameters = {
    ...
    pendingInterceptors() {
      ...
      return Array.from(mockAgentClients.entries())
        .flatMap(([origin, scope]) =>
          scope[kDispatches].map((dispatch) => ({
            ...dispatch,
            origin,
          })),
        )
      ...
      if (this[kHeadersMap].size !== 0)
        for (const {
          ...
          if (lowerName === "set-cookie")
            for (const cookie of this.cookies) headers.push([name, cookie]);
...
var require_response = /* @__PURE__ */ __commonJSMin((exports, module) => {
  const { Headers, HeadersList, fill, getHeadersGuard, setHeadersGuard, setHeadersList } =
    require_headers();
  const {
    extractBody,
    cloneBody,
  ...
  webidl.converters.XMLHttpRequestBodyInit = function (V, prefix, name) {
    ...
    if (ArrayBuffer.isView(V) || types$3.isArrayBuffer(V))
...
var require_fetch = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const { redirectStatusSet, nullBodyStatus, safeMethodsSet, requestBodyHeader, subresourceSet } =
    require_constants$2();
  const EE = __require("node:events");
  const { Readable, pipeline: pipeline$2, finished } = __require("node:stream");
  const { addAbortListener, isErrored, isReadable, bufferToLowerCasedHeaderName } =
    require_util$7();
  ...
  function fetching({
    ...
    const timingInfo = createOpaqueTimingInfo({
      startTime: coarsenedSharedCurrentTime(crossOriginIsolatedCapability),
    });
    const fetchParams = {
    ...
    function onAborted(reason) {
      if (isAborted(fetchParams)) {
        ...
        fetchParams.controller.controller.error(
          new TypeError("terminated", { cause: isErrorLike(reason) ? reason : void 0 }),
        );
      fetchParams.controller.connection.destroy();
    }
    return response;
        ...
        agent.dispatch(
          ...
          },
          {
            ...
            onHeaders(status, rawHeaders, resume, statusText) {
              ...
              const decoders = [];
              const willFollow =
                location && request.redirect === "follow" && redirectStatusSet.has(status);
              if (
                request.method !== "HEAD" &&
                request.method !== "CONNECT" &&
              ...
              resolve({
                ...
                body: decoders.length
                  ? pipeline$2(this.body, ...decoders, (err) => {
  ...
  var Cache = class Cache {
    ...
    async put(request, response) {
      ...
      if (innerResponse.body != null)
        readAllBytes(innerResponse.body.stream.getReader()).then(
    ...
    #requestMatchesCachedItem(requestQuery, request, response = null, options) {
      ...
      for (const fieldValue of fieldValues) {
        ...
        if (request.headersList.get(fieldValue) !== requestQuery.headersList.get(fieldValue))
          return false;
      }
      return true;
    }
    ...
    async match(request, options = {}) {
      ...
      if (options.cacheName != null) {
        if (this.#caches.has(options.cacheName))
          return await new Cache(kConstruct, this.#caches.get(options.cacheName)).match(
            request,
            options,
          );
      } else
...
var require_parse = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function parseUnparsedAttributes(unparsedAttributes, cookieAttributeList = {}) {
    ...
    if (attributeNameLowercase === "expires")
      cookieAttributeList.expires = new Date(attributeValue);
  ...
  function establishWebSocketConnection(url, protocols, client, ws, onEstablish, options) {
    ...
    return fetching({
      ...
      processResponse(response) {
        ...
        if (
          response.headersList.get("Sec-WebSocket-Accept") !==
          crypto
            .createHash("sha1")
            .update(keyValue + uid)
            .digest("base64")
        ...
        if (secProtocol !== null) {
          if (
            !getDecodeSplit("sec-websocket-protocol", request.headersList).includes(secProtocol)
          ) {
...
var require_websocket = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const { isConnecting, isEstablished, isClosing, isValidSubprotocol, fireEvent } =
    require_util$1();
  ...
  webidl.converters.WebSocketSendData = function (V) {
    if (webidl.util.Type(V) === "Object") {
      ...
      if (ArrayBuffer.isView(V) || types$1.isArrayBuffer(V))
...
var HttpClient = class {
  ...
  getJson(requestUrl_1) {
    return __awaiter$9(this, arguments, void 0, function* (requestUrl, additionalHeaders = {}) {
      additionalHeaders[Headers$1.Accept] = this._getExistingOrDefaultHeader(
        additionalHeaders,
        Headers$1.Accept,
  ...
  postJson(requestUrl_1, obj_1) {
    return __awaiter$9(
      ...
      function* (requestUrl, obj, additionalHeaders = {}) {
        ...
        additionalHeaders[Headers$1.ContentType] = this._getExistingOrDefaultContentTypeHeader(
          additionalHeaders,
          MediaTypes.ApplicationJson,
        );
  ...
  _getExistingOrDefaultContentTypeHeader(additionalHeaders, _default) {
    let clientHeader;
    if (this.requestOptions && this.requestOptions.headers) {
      const headerValue = lowercaseKeys(this.requestOptions.headers)[Headers$1.ContentType];
      if (headerValue)
  ...
  _getAgent(parsedUrl) {
    ...
    if (proxyUrl && proxyUrl.hostname) {
      ...
      if (usingSsl)
        tunnelAgent = overHttps ? import_tunnel.httpsOverHttps : import_tunnel.httpsOverHttp;
...
var OidcClient = class OidcClient {
  ...
  static getCall(id_token_url) {
    return __awaiter$7(this, void 0, void 0, function* () {
      var _a;
      const id_token =
        (_a = (yield OidcClient.createHttpClient()
          .getJson(id_token_url)
          .catch((error) => {
            throw new Error(`Failed to get ID Token. \n 
        Error Code : ${error.statusCode}\n 
        Error Message: ${error.message}`);
          })).result) === null || _a === void 0
          ? void 0
          : _a.value;
...
const { chmod, copyFile, lstat, mkdir, open, readdir, rename, rm, rmdir, stat, symlink, unlink } =
  fs.promises;
...
function isUnixExecutable(stats) {
  return (
    (stats.mode & 1) > 0 ||
    ((stats.mode & 8) > 0 && process.getgid !== void 0 && stats.gid === process.getgid()) ||
      ...
      return new Promise((resolve, reject) =>
        __awaiter$3(this, void 0, void 0, function* () {
          ...
          if (this.options.cwd && !(yield exists(this.options.cwd)))
            return reject(
              /* @__PURE__ */ new Error(`The cwd: ${this.options.cwd} does not exist!`),
            );
...
const getWindowsInfo = () =>
  __awaiter$1(void 0, void 0, void 0, function* () {
    const { stdout: version } = yield getExecOutput(
      'powershell -command "(Get-CimInstance -ClassName Win32_OperatingSystem).Version"',
      void 0,
      { silent: true },
    );
    const { stdout: name } = yield getExecOutput(
...
const getMacOsInfo = () =>
  __awaiter$1(void 0, void 0, void 0, function* () {
    ...
    return {
      name:
        (_d =
          (_c = stdout.match(/ProductName:\s*(.+)/)) === null || _c === void 0 ? void 0 : _c[1]) !==
          null && _d !== void 0
          ? _d
          : "",
      version,
...
const getLinuxInfo = () =>
  __awaiter$1(void 0, void 0, void 0, function* () {
    const { stdout } = yield getExecOutput("lsb_release", ["-i", "-r", "-s"], { silent: true });
...
function getDetails() {
  return __awaiter$1(this, void 0, void 0, function* () {
    return Object.assign(
      Object.assign(
        {},
        yield isWindows ? getWindowsInfo() : isMacOS ? getMacOsInfo() : getLinuxInfo(),
      ),
      {
        platform,
        arch,
  ...
  be = (i, o, a) =>
    o.has(i)
      ...
      : o instanceof WeakSet
        ? o.add(i)
        : o.set(i, a),
  X = (i, o, a, f) => (ci(i, o, "write to private field"), f ? f.call(i, a) : o.set(i, a), a);
...
function Us(i) {
  ...
  for (let A = 1; A < a.length; A++)
    a[A] === "base64"
      ? (l = !0)
      : a[A] && ((h += `;${a[A]}`), a[A].indexOf("charset=") === 0 && (f = a[A].substring(8)));
  !a[0] && !f.length && ((h += ";charset=US-ASCII"), (f = "US-ASCII"));
  const S = l ? "base64" : "ascii",
    v = unescape(i.substring(o + 1)),
    w = Buffer.from(v, S);
    ...
    bi ||
      ...
      (function (i, o) {
        (function (a, f) {
          ...
          const U = 16384,
            bn = class bn {
              ...
              push(t) {
                const r = this._back;
                let s = r;
                (r._elements.length === U - 1 &&
                  (s = {
                    _elements: [],
                    _next: void 0,
                  }),
                  r._elements.push(t),
                  s !== r && ((this._back = s), (r._next = s)),
                  ++this._size);
              }
              shift() {
                const t = this._front;
              ...
              forEach(t) {
                ...
                for (
                  ;
                  (r !== u.length || s._next !== void 0) &&
                  !(r === u.length && ((s = s._next), (u = s._elements), (r = 0), u.length === 0));
                )
                  (t(u[r]), ++r);
              }
              peek() {
          ...
          n$1(bn, "SimpleQueue");
          let D = bn;
          const jt = Symbol("[[AbortSteps]]"),
            Qn = Symbol("[[ErrorSteps]]"),
            Ar = Symbol("[[CancelSteps]]"),
            Br = Symbol("[[PullSteps]]"),
            kr = Symbol("[[ReleaseSteps]]");
          function Yn(e, t) {
          ...
          function _e(e) {
            ...
            (t._state === "readable"
              ...
              t._readableStreamController[kr](),
              (t._reader = void 0),
          ...
          const mn = class mn {
            constructor(t) {
              if ((Se(t, 1, "ReadableStreamDefaultReader"), jr(t, "First parameter"), qe(t)))
                throw new TypeError(
          ...
          (Object.defineProperties(fe.prototype, {
            ...
            h(fe.prototype.cancel, "cancel"),
            h(fe.prototype.read, "read"),
            h(fe.prototype.releaseLock, "releaseLock"),
          ...
          function Ee(e) {
            return !l(e) || !Object.prototype.hasOwnProperty.call(e, "_readRequests")
              ? !1
              : e instanceof fe;
          }
            ...
            ((r._disturbed = !0),
              r._state === "closed"
                ...
                : r._state === "errored"
                  ...
                  : r._readableStreamController[Br](t));
          }
          ...
          const Zi = Object.getPrototypeOf(Object.getPrototypeOf(async function* () {}).prototype),
            yn = class yn {
              constructor(t, r) {
          ...
          let we = n$1(
              (e) => (
                typeof e.transfer == "function"
                  ? (we = n$1((t) => t.transfer(), "TransferArrayBuffer"))
                  : typeof structuredClone == "function"
                    ? (we = n$1(
                        (t) => structuredClone(t, { transfer: [t] }),
                        "TransferArrayBuffer",
                      ))
                    : (we = n$1((t) => t, "TransferArrayBuffer")),
                we(e)
              ),
              "TransferArrayBuffer",
            ),
            Ae = n$1(
              (e) => (
                typeof e.detached == "boolean"
                  ? (Ae = n$1((t) => t.detached, "IsDetachedBuffer"))
                  : (Ae = n$1((t) => t.byteLength === 0, "IsDetachedBuffer")),
                Ae(e)
              ),
              "IsDetachedBuffer",
            );
          ...
          const Ur =
            (Mr =
              ($r = Symbol.asyncIterator) !== null && $r !== void 0
                ? $r
                : (Dr = Symbol.for) === null || Dr === void 0
                  ? void 0
                  : Dr.call(Symbol, "Symbol.asyncIterator")) !== null && Mr !== void 0
              ? Mr
              : "@@asyncIterator";
            ...
            if (r === void 0)
              if (t === "async") {
                if (((r = Ut(e, Ur)), r === void 0))
                  return Ji(uo(e, "sync", Ut(e, Symbol.iterator)));
          ...
          (Object.defineProperties(Re.prototype, {
            ...
            h(Re.prototype.respond, "respond"),
            h(Re.prototype.respondWithNewView, "respondWithNewView"),
            typeof Symbol.toStringTag == "symbol" &&
          ...
          const _n = class _n {
            ...
            close() {
              ...
              if (t !== "readable")
                throw new TypeError(
                  `The stream (in ${t} state) is not in the readable state and cannot be closed`,
                );
              wt(this);
            }
            enqueue(t) {
              ...
              if (r !== "readable")
                throw new TypeError(
                  `The stream (in ${r} state) is not in the readable state and cannot be enqueued to`,
                );
              Ht(this, t);
            }
            error(t = void 0) {
          ...
          (Object.defineProperties(te.prototype, {
            ...
            h(te.prototype.close, "close"),
            h(te.prototype.enqueue, "enqueue"),
            h(te.prototype.error, "error"),
            typeof Symbol.toStringTag == "symbol" &&
          ...
          function Fe(e) {
            ...
            g(
              e._pullAlgorithm(),
              () => ((e._pulling = !1), e._pullAgain && ((e._pullAgain = !1), Fe(e)), null),
              (s) => (K(e, s), null),
            );
          }
          ...
          function yo(e, t) {
            ...
            for (; u > 0; ) {
              const y = R.peek(),
                C = Math.min(u, y.byteLength),
                P = t.byteOffset + t.bytesFilled;
              (so(t.buffer, P, y.buffer, y.byteOffset, C),
                y.byteLength === C ? R.shift() : ((y.byteOffset += C), (y.byteLength -= C)),
                (e._queueTotalSize -= C),
                go(e, C, t),
                (u -= C));
            }
          ...
          function _o(e) {
            e._queueTotalSize === 0 && e._closeRequested
              ? (Nt(e), At(e._controlledReadableByteStream))
              : Fe(e);
          }
          ...
          function sa(e, t, r, s) {
            const u = e._controlledReadableByteStream,
              c = t.constructor,
              d = ia(c),
              { byteOffset: m, byteLength: R } = t,
              y = r * d;
            let C;
            try {
              C = we(t.buffer);
            ...
            if (e._queueTotalSize > 0) {
              ...
              if (e._closeRequested) {
                const B = /* @__PURE__ */ new TypeError(
          ...
          function So(e, t) {
            ...
            (Qr(e),
              e._controlledReadableByteStream._state === "closed" ? la(e, r) : ua(e, t, r),
              Fe(e));
          }
            ...
            if (!(e._closeRequested || t._state !== "readable")) {
              ...
              if (e._pendingPullIntos.length > 0) {
                ...
                if (r.bytesFilled % r.elementSize !== 0) {
                  const s = /* @__PURE__ */ new TypeError(
                    "Insufficient bytes to fill elements in the given buffer",
                  );
                  throw (K(e, s), s);
                }
          ...
          function To(e, t, r, s, u, c, d) {
            ((t._controlledReadableByteStream = e),
              ...
              (t._strategyHWM = c),
              (t._pullAlgorithm = s),
              (t._cancelAlgorithm = u),
              (t._autoAllocateChunkSize = d),
              (t._pendingPullIntos = new D()),
              (e._readableStreamController = t));
            g(
              T(r()),
              () => ((t._started = !0), Fe(t), null),
              (R) => (K(t, R), null),
            );
          }
          ...
          function ca(e, t, r) {
            ...
            let u, c, d;
            (t.start !== void 0
              ? (u = n$1(() => t.start(s), "startAlgorithm"))
              : (u = n$1(() => {}, "startAlgorithm")),
              t.pull !== void 0
                ? (c = n$1(() => t.pull(s), "pullAlgorithm"))
                : (c = n$1(() => T(void 0), "pullAlgorithm")),
              t.cancel !== void 0
                ? (d = n$1((R) => t.cancel(R), "cancelAlgorithm"))
                : (d = n$1(() => T(void 0), "cancelAlgorithm")));
          ...
          function ba(e, t) {
            ...
            ue(e, t);
            return {
              min: Fr((r = e?.min) !== null && r !== void 0 ? r : 1, `${t} has member 'min' that`),
            };
          }
          ...
          const Sn = class Sn {
            constructor(t) {
              if ((Se(t, 1, "ReadableStreamBYOBReader"), jr(t, "First parameter"), qe(t)))
                throw new TypeError(
                  "This stream has already been locked for exclusive reading by another reader",
                );
              if (!Ie(t._readableStreamController))
                throw new TypeError(
            ...
            read(t, r = {}) {
              ...
              if (!ArrayBuffer.isView(t))
                return b(/* @__PURE__ */ new TypeError("view must be an array buffer view"));
              if (t.byteLength === 0)
                return b(/* @__PURE__ */ new TypeError("view must have non-zero byteLength"));
              if (t.buffer.byteLength === 0)
                return b(
                  /* @__PURE__ */ new TypeError("view's buffer must have non-zero byteLength"),
                );
              if (Ae(t.buffer))
                return b(/* @__PURE__ */ new TypeError("view's buffer has been detached"));
              let s;
              try {
                s = ba(r, "options");
              } catch (y) {
              ...
              const u = s.min;
              if (u === 0)
                return b(/* @__PURE__ */ new TypeError("options.min must be greater than 0"));
              if (oa(t)) {
                if (u > t.byteLength)
                  return b(
          ...
          (Object.defineProperties(ce.prototype, {
            ...
            h(ce.prototype.cancel, "cancel"),
            h(ce.prototype.read, "read"),
            h(ce.prototype.releaseLock, "releaseLock"),
            typeof Symbol.toStringTag == "symbol" &&
          ...
          function je(e) {
            return !l(e) || !Object.prototype.hasOwnProperty.call(e, "_readIntoRequests")
              ? !1
              : e instanceof ce;
          }
          ...
          function Eo(e, t, r, s) {
            ...
            ((u._disturbed = !0),
              u._state === "errored"
                ? s._errorSteps(u._storedError)
                : sa(u._readableStreamController, t, r, s));
          }
          ...
          const wn = class wn {
            constructor(t = {}, r = {}) {
              ...
              const s = Zt(r, "Second parameter"),
                u = _a(t, "First parameter");
            ...
            close() {
              return Ge(this)
                ? Ze(this)
                  ...
                  : he(this)
                    ? b(/* @__PURE__ */ new TypeError("Cannot close an already-closing stream"))
                    : qo(this)
                : b(tr("close"));
            }
            getWriter() {
          ...
          (Object.defineProperties(de.prototype, {
            ...
            h(de.prototype.abort, "abort"),
            h(de.prototype.close, "close"),
            h(de.prototype.getWriter, "getWriter"),
            typeof Symbol.toStringTag == "symbol" &&
          ...
          function qo(e) {
            ...
            const r = A((u, c) => {
              ...
              s = e._writer;
            return (
              s !== void 0 && e._backpressure && t === "writable" && ln(s),
              Ma(e._writableStreamController),
              r
            );
          }
          ...
          function en(e) {
            ...
            g(
              e._writableStreamController[jt](r._reason),
              () => (r._resolve(), Jt(e), null),
              (u) => (r._reject(u), Jt(e), null),
            );
          }
          ...
          const Rn = class Rn {
            constructor(t) {
              if ((Se(t, 1, "WritableStreamDefaultWriter"), Bo(t, "First parameter"), Ze(t)))
                throw new TypeError(
          ...
          (Object.defineProperties(re.prototype, {
            ...
            h(re.prototype.abort, "abort"),
            h(re.prototype.close, "close"),
            h(re.prototype.releaseLock, "releaseLock"),
            h(re.prototype.write, "write"),
            typeof Symbol.toStringTag == "symbol" &&
              Object.defineProperty(re.prototype, Symbol.toStringTag, {
          ...
          function rn(e) {
            return !l(e) || !Object.prototype.hasOwnProperty.call(e, "_controlledWritableStream")
              ? !1
              : e instanceof ke;
          }
          ...
          function Lo(e, t, r, s, u, c, d, m) {
            ((t._controlledWritableStream = e),
              ...
              (t._abortController = va()),
              (t._started = !1),
              (t._strategySizeAlgorithm = m),
              (t._strategyHWM = d),
              (t._writeAlgorithm = s),
              (t._closeAlgorithm = u),
              (t._abortAlgorithm = c));
            ...
            g(
              T(r()),
              () => ((t._started = !0), er(t), null),
              (P) => ((t._started = !0), Jr(e, P), null),
            );
          }
          ...
          function Da(e, t, r, s) {
            ...
            let c, d, m, R;
            (t.start !== void 0
              ? (c = n$1(() => t.start(u), "startAlgorithm"))
              : (c = n$1(() => {}, "startAlgorithm")),
              t.write !== void 0
                ? (d = n$1((y) => t.write(y, u), "writeAlgorithm"))
                : (d = n$1(() => T(void 0), "writeAlgorithm")),
              t.close !== void 0
                ? (m = n$1(() => t.close(), "closeAlgorithm"))
                : (m = n$1(() => T(void 0), "closeAlgorithm")),
              t.abort !== void 0
                ? (R = n$1((y) => t.abort(y), "abortAlgorithm"))
                : (R = n$1(() => T(void 0), "abortAlgorithm")),
              Lo(e, u, c, d, m, R, r, s));
          }
          ...
          function Ho(e, t, r, s, u, c) {
            ...
            return A((C, P) => {
              ...
              if (c !== void 0) {
                if (
                  ((B = n$1(() => {
                    const _ = c.reason !== void 0 ? c.reason : new es("Aborted", "AbortError"),
                      E = [];
                    (s || E.push(() => (t._state === "writable" ? Kt(t, _) : T(void 0))),
                      u || E.push(() => (e._state === "readable" ? ie(e, _) : T(void 0))),
                      N(() => Promise.all(E.map((k) => k())), !0, _));
                  }, "abortAlgorithm")),
                  c.aborted)
                ) {
                  B();
              ...
              if (
                (n$1(nt, "pipeStep"),
                Te(e, d._closedPromise, (_) => (s ? J(!0, _) : N(() => Kt(t, _), !0, _), null)),
                Te(t, m._closedPromise, (_) => (u ? J(!0, _) : N(() => ie(e, _), !0, _), null)),
                x(e, d._closedPromise, () => (r ? J() : N(() => ja(m)), null)),
                he(t) || t._state === "closed")
              ) {
                const _ = /* @__PURE__ */ new TypeError(
              ...
              function J(_, E) {
                R ||
                  ((R = !0),
                  t._state === "writable" && !he(t) ? V(Oe(), () => Ce(_, E)) : Ce(_, E));
              }
              n$1(J, "shutdown");
              function Ce(_, E) {
                return (
                  Io(m),
                  _e(d),
                  c !== void 0 && c.removeEventListener("abort", B),
                  _ ? P(E) : C(void 0),
                  null
                );
              }
          ...
          const Cn = class Cn {
            ...
            [Br](t) {
              ...
              if (this._queue.length > 0) {
                const s = xr(this);
                (this._closeRequested && this._queue.length === 0 ? (ir(this), At(r)) : vt(this),
                  t._chunkSteps(s));
              } else (eo(r, t), vt(this));
            }
            [kr]() {}
          ...
          (Object.defineProperties(ne.prototype, {
            ...
            h(ne.prototype.close, "close"),
            h(ne.prototype.enqueue, "enqueue"),
            h(ne.prototype.error, "error"),
            typeof Symbol.toStringTag == "symbol" &&
          ...
          function or(e) {
            return !l(e) || !Object.prototype.hasOwnProperty.call(e, "_controlledReadableStream")
              ? !1
              : e instanceof ne;
          }
          ...
          function vt(e) {
            ...
            g(
              e._pullAlgorithm(),
              () => ((e._pulling = !1), e._pullAgain && ((e._pullAgain = !1), vt(e)), null),
              (s) => (oe(e, s), null),
            );
          }
          ...
          function rs(e, t, r, s) {
            ...
            (t.start !== void 0
              ...
              : (c = n$1(() => {}, "startAlgorithm")),
              t.pull !== void 0
                ? (d = n$1(() => t.pull(u), "pullAlgorithm"))
                : (d = n$1(() => T(void 0), "pullAlgorithm")),
              t.cancel !== void 0
                ? (m = n$1((R) => t.cancel(R), "cancelAlgorithm"))
                : (m = n$1(() => T(void 0), "cancelAlgorithm")),
              Qo(e, u, c, d, m, r, s));
          }
          ...
          function os(e, t) {
                  ...
                  _t(r, {
                    _chunkSteps: n$1((N) => {
                      ge(() => {
                        ...
                        const J = N,
                          Ce = N;
                        (c || Ke(y._readableStreamController, J),
                          d || Ke(C._readableStreamController, Ce),
                          (s = !1),
                          u && ae());
                      });
                    }, "_chunkSteps"),
                    _closeSteps: n$1(() => {
                      ((s = !1),
                        c || De(y._readableStreamController),
                        d || De(C._readableStreamController),
                        (!c || !d) && P(void 0));
                    }, "_closeSteps"),
                    _errorSteps: n$1(() => {
                      s = !1;
            ...
            function Te() {}
            return (
              n$1(Te, "startAlgorithm"),
              (y = Et(Te, ae, nt)),
              (C = Et(Te, ae, Oe)),
              I(
                r._closedPromise,
                (x) => (
                  oe(y._readableStreamController, x),
                  oe(C._readableStreamController, x),
                  (!c || !d) && P(void 0),
                  null
                ),
              ),
          ...
          function is(e) {
            ...
            function ae(_) {
              I(
                ...
                (E) => (
                  _ !== t ||
                    (K(y._readableStreamController, E),
                    K(C._readableStreamController, E),
                    (!c || !d) && P(void 0)),
                  null
                ),
              );
            ...
            function nt() {
              (je(t) && (_e(t), (t = Qe(e)), ae(t)),
                _t(t, {
                    ...
                    ge(() => {
                      ...
                      if (!c && !d)
                        try {
                          ...
                          (K(y._readableStreamController, ot),
                            K(C._readableStreamController, ot),
                            P(ie(e, ot)));
                          return;
                        }
                      (c || Ht(y._readableStreamController, k),
                        d || Ht(C._readableStreamController, Y),
                        (r = !1),
                        s ? Te() : u && x());
                    });
                  }, "_chunkSteps"),
                  _closeSteps: n$1(() => {
                    ((r = !1),
                      c || wt(y._readableStreamController),
                      d || wt(C._readableStreamController),
                      y._readableStreamController._pendingPullIntos.length > 0 &&
                        Vt(y._readableStreamController, 0),
                      C._readableStreamController._pendingPullIntos.length > 0 &&
                        Vt(C._readableStreamController, 0),
                      (!c || !d) && P(void 0));
                  }, "_closeSteps"),
                  _errorSteps: n$1(() => {
                    r = !1;
            ...
            function Oe(_, E) {
              ...
              Eo(t, _, 1, {
                  ...
                  ge(() => {
                    ...
                    if (E ? c : d) at || Qt(k._readableStreamController, it);
                      ...
                      try {
                        ...
                        (K(k._readableStreamController, kn),
                          K(Y._readableStreamController, kn),
                          P(ie(e, kn)));
                        return;
                      }
                      (at || Qt(k._readableStreamController, it),
                        Ht(Y._readableStreamController, ui));
                    }
                    ((r = !1), s ? Te() : u && x());
                  });
                }, "_chunkSteps"),
                _closeSteps: n$1((it) => {
                  ...
                  const at = E ? d : c,
                    cr = E ? c : d;
                  (at || wt(k._readableStreamController),
                    cr || wt(Y._readableStreamController),
                    it !== void 0 &&
                      (at || Qt(k._readableStreamController, it),
                      !cr &&
                        Y._readableStreamController._pendingPullIntos.length > 0 &&
            ...
            function Ce() {}
            return (
              n$1(Ce, "startAlgorithm"), (y = Go(Ce, Te, N)), (C = Go(Ce, x, J)), ae(t), [y, C]
            );
          }
          ...
          function fs(e, t) {
            ...
            return {
              autoAllocateChunkSize:
                s === void 0 ? void 0 : Fr(s, `${t} has member 'autoAllocateChunkSize' that`),
          ...
          function Yo(e, t) {
            ue(e, t);
            const r = e?.preventAbort,
              s = e?.preventCancel,
              u = e?.preventClose,
              c = e?.signal;
            return (
              c !== void 0 && ms(c, `${t} has member 'signal' that`),
              {
                preventAbort: !!r,
                preventCancel: !!s,
                preventClose: !!u,
          ...
          function ys(e, t) {
            ...
            const s = e?.writable;
            return (
              zr(s, "writable", "ReadableWritablePair"),
              Bo(s, `${t} has member 'writable' that`),
              {
                readable: r,
                writable: s,
              }
          ...
          const Pn = class Pn {
            ...
            pipeThrough(t, r = {}) {
              ...
              Se(t, 1, "pipeThrough");
              const s = ys(t, "First parameter"),
                u = Yo(r, "Second parameter");
              if (qe(this))
                throw new TypeError(
              ...
              return (
                Q(Ho(this, s.writable, u.preventClose, u.preventAbort, u.preventCancel, u.signal)),
                s.readable
              );
            }
            pipeTo(t, r = {}) {
              ...
              return qe(this)
                ...
                : Ze(t)
                  ...
                  : Ho(this, t, s.preventClose, s.preventAbort, s.preventCancel, s.signal);
            }
            tee() {
          ...
          let L = Pn;
          (Object.defineProperties(L, { from: { enumerable: !0 } }),
            ...
            h(L.from, "from"),
            h(L.prototype.cancel, "cancel"),
            h(L.prototype.getReader, "getReader"),
            h(L.prototype.pipeThrough, "pipeThrough"),
            h(L.prototype.pipeTo, "pipeTo"),
            h(L.prototype.tee, "tee"),
            h(L.prototype.values, "values"),
            typeof Symbol.toStringTag == "symbol" &&
          ...
          function We(e) {
            return !l(e) || !Object.prototype.hasOwnProperty.call(e, "_readableStreamController")
              ? !1
              : e instanceof L;
          }
          ...
          const vn = class vn {
            constructor(t) {
              (Se(t, 1, "ByteLengthQueuingStrategy"),
                (t = Ko(t, "First parameter")),
                (this._byteLengthQueuingStrategyHighWaterMark = t.highWaterMark));
            }
            get highWaterMark() {
          ...
          const En = class En {
            constructor(t) {
              (Se(t, 1, "CountQueuingStrategy"),
                (t = Ko(t, "First parameter")),
                (this._countQueuingStrategyHighWaterMark = t.highWaterMark));
            }
            get highWaterMark() {
          ...
          const An = class An {
            constructor(t = {}, r = {}, s = {}) {
              t === void 0 && (t = null);
              const u = Zt(r, "Second parameter"),
                c = Zt(s, "Third parameter"),
                d = gs(t, "First parameter");
              ...
              (Ts(this, B, y, C, m, R),
                Ps(this, d),
                d.start !== void 0 ? P(d.start(this._transformStreamController)) : P(void 0));
            }
            get readable() {
          ...
          function Ts(e, t, r, s, u, c) {
            ...
            (n$1(P, "cancelAlgorithm"),
              (e._readable = Et(d, C, P, u, c)),
          ...
          function oi(e) {
            return !l(e) || !Object.prototype.hasOwnProperty.call(e, "_transformStreamController")
              ? !1
              : e instanceof tt;
          }
          ...
          function sr(e, t) {
            (e._backpressureChangePromise !== void 0 && e._backpressureChangePromise_resolve(),
              (e._backpressureChangePromise = A((r) => {
          ...
          (Object.defineProperties(pe.prototype, {
            ...
            h(pe.prototype.enqueue, "enqueue"),
            h(pe.prototype.error, "error"),
            h(pe.prototype.terminate, "terminate"),
            typeof Symbol.toStringTag == "symbol" &&
          ...
          function lr(e) {
            return !l(e) || !Object.prototype.hasOwnProperty.call(e, "_controlledTransformStream")
              ? !1
              : e instanceof pe;
          }
          ...
          function Ps(e, t) {
            ...
            let s, u, c;
            (t.transform !== void 0
              ? (s = n$1((d) => t.transform(d, r), "transformAlgorithm"))
              : (s = n$1((d) => {
                  try {
              ...
              t.flush !== void 0
                ? (u = n$1(() => t.flush(r), "flushAlgorithm"))
                : (u = n$1(() => T(void 0), "flushAlgorithm")),
              t.cancel !== void 0
                ? (c = n$1((d) => t.cancel(d), "cancelAlgorithm"))
                : (c = n$1(() => T(void 0), "cancelAlgorithm")),
              Cs(e, r, s, u, c));
          }
          ...
          function ai(e, t) {
            const r = e._controlledTransformStream,
              s = r._readable._readableStreamController;
            ...
            return (
              ...
              g(
                ...
                () => (
                  s._state === "errored"
                    ? rt(r, s._storedError)
                    : (oe(s._readableStreamController, t), pn(r)),
                  null
                ),
                (c) => (oe(s._readableStreamController, c), rt(r, c), null),
              ),
              r._finishPromise
            );
          }
            ...
            return (
              ...
              g(
                ...
                () => (
                  r._state === "errored"
                    ? rt(t, r._storedError)
                    : (De(r._readableStreamController), pn(t)),
                  null
                ),
                (u) => (oe(r._readableStreamController, u), rt(t, u), null),
              ),
              t._finishPromise
            );
          }
            ...
            return (
              ...
              g(
                ...
                () => (
                  s._state === "errored"
                    ? rt(r, s._storedError)
                    : (Ct(s._writableStreamController, t), hn(e), pn(r)),
                  null
                ),
                (c) => (Ct(s._writableStreamController, c), hn(e), rt(r, c), null),
              ),
              r._finishPromise
            );
          }
          ...
          (n$1(li, "streamBrandCheckException"),
            (a.ByteLengthQueuingStrategy = Xe),
            (a.CountQueuingStrategy = et),
            (a.ReadableByteStreamController = te),
            (a.ReadableStream = L),
            (a.ReadableStreamBYOBReader = ce),
            (a.ReadableStreamBYOBRequest = Re),
            (a.ReadableStreamDefaultController = ne),
            (a.ReadableStreamDefaultReader = fe),
            (a.TransformStream = tt),
            (a.TransformStreamDefaultController = pe),
            (a.WritableStream = de),
            (a.WritableStreamDefaultController = ke),
            (a.WritableStreamDefaultWriter = re));
        });
      })(kt, kt.exports)),
    kt.exports
  );
...
function Hs() {
  ...
  if (!globalThis.ReadableStream)
    try {
      const o = __require("node:process"),
        { emitWarning: a } = o;
      try {
        ((o.emitWarning = () => {}),
  ...
  try {
    ...
    o &&
      !o.prototype.stream &&
      (o.prototype.stream = n$1(function (f) {
        let l = 0;
        const p = this;
        return new ReadableStream({
          type: "bytes",
...
async function* Wn(i, o = !0) {
  for (const a of i)
    if ("stream" in a) yield* a.stream();
    else if (ArrayBuffer.isView(a))
      if (o) {
        let f = a.byteOffset;
        const l = a.byteOffset + a.byteLength;
        for (; f !== l; ) {
          const p = Math.min(l - f, yi),
            h = a.buffer.slice(f, f + p);
...
const gi =
  ((ze = class {
      ...
      for (const p of o) {
        ...
        (ArrayBuffer.isView(p)
          ...
          : p instanceof ArrayBuffer
            ? (h = new Uint8Array(p.slice(0)))
            : p instanceof ze
              ? (h = p)
              : (h = f.encode(`${p}`)),
          X(this, bt, O(this, bt) + (ArrayBuffer.isView(h) ? h.byteLength : h.size)),
          O(this, ve).push(h));
      }
    ...
    slice(o = 0, a = this.size, f = "") {
      const { size: l } = this;
      let p = o < 0 ? Math.max(l + o, 0) : Math.min(o, l),
        h = a < 0 ? Math.max(l + a, 0) : Math.min(a, l);
      const S = Math.max(h - p, 0),
        v = O(this, ve),
        w = [];
      let A = 0;
      for (const b of v) {
        ...
        if (p && q <= p) ((p -= q), (h -= q));
          ...
          (ArrayBuffer.isView(b)
            ? ((g = b.subarray(p, Math.min(q, h))), (A += g.byteLength))
            : ((g = b.slice(p, Math.min(q, h))), (A += g.size)),
            (h -= q),
            w.push(g),
            (p = 0));
        }
    ...
    static [Symbol.hasInstance](o) {
      return (
        ...
        /^(Blob|File)$/.test(o[Symbol.toStringTag])
      );
    }
  }),
...
var { toStringTag: Wt, iterator: Qs, hasInstance: Ys } = Symbol,
  ...
  Si = n$1(
    (i, o, a) => (
      (i += ""),
      /^(Blob|File)$/.test(o && o[Wt])
        ? [
            ((a = a !== void 0 ? a + "" : o[Wt] == "File" ? o.name : "blob"), i),
            o.name !== a || o[Wt] == "blob" ? new qn([o], a, o) : o,
          ]
        : [i, o + ""]
    ),
    "f",
...
`,
  ...
  Ue = n$1((i, o, a) => {
    if (o.length < a)
      throw new TypeError(
        `Failed to execute '${i}' on 'FormData': ${a} arguments required, but only ${o.length} present.`,
      );
  }, "x");
const br =
  ((yt = class {
    ...
    delete(o) {
      (Ue("delete", arguments, 1),
        (o += ""),
        X(
          this,
          ee,
          O(this, ee).filter(([a]) => a !== o),
        ));
    }
    get(o) {
    ...
    getAll(o, a) {
      return (
        Ue("getAll", arguments, 1),
        (a = []),
        (o += ""),
        O(this, ee).forEach((f) => f[0] === o && a.push(f[1])),
        a
      );
    }
    has(o) {
  ...
  yt);
function Zs(i, o = ut) {
  var a = `${_i()}${_i()}`.replace(/\./g, "").slice(-28).padStart(32, "-"),
    f = [],
    l = `--${a}\r
...
`,
    ...
    f.push(`--${a}--`),
    new o(f, { type: "multipart/form-data; boundary=" + a })
  );
}
...
n$1(xn, "FetchError");
let G = xn;
const mr = Symbol.toStringTag,
  wi = n$1(
    (i) =>
      typeof i == "object" &&
      typeof i.append == "function" &&
      typeof i.delete == "function" &&
      typeof i.get == "function" &&
      typeof i.getAll == "function" &&
      typeof i.has == "function" &&
      typeof i.set == "function" &&
      typeof i.sort == "function" &&
      i[mr] === "URLSearchParams",
  ...
  Ks = n$1(
    (i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"),
    "isAbortSignal",
  ),
  Js = n$1((i, o) => {
    const a = new URL(o).hostname,
  ...
  Nn = class Nn {
    constructor(o, { size: a = 0 } = {}) {
      ...
      o === null
        ? (o = null)
        : wi(o)
          ? (o = Buffer$1.from(o.toString()))
          : yr(o) ||
            Buffer$1.isBuffer(o) ||
            (types.isAnyArrayBuffer(o)
              ? (o = Buffer$1.from(o))
              : ArrayBuffer.isView(o)
                ? (o = Buffer$1.from(o.buffer, o.byteOffset, o.byteLength))
                : o instanceof me ||
                  (o instanceof br
                    ? ((o = Zs(o)), (f = o.type.split("=")[1]))
                    : (o = Buffer$1.from(String(o)))));
      let l = o;
      (Buffer$1.isBuffer(o)
        ? (l = me.Readable.from(o))
        : yr(o) && (l = me.Readable.from(o.stream())),
        (this[H] = {
          body: o,
          stream: l,
          boundary: f,
          ...
          o.on("error", (p) => {
            const h =
              p instanceof ft
                ? p
                : new G(
                    `Invalid response body while trying to fetch ${this.url}: ${p.message}`,
                    "system",
                    p,
                  );
            this[H].error = h;
    ...
    async formData() {
      ...
      if (o.startsWith("application/x-www-form-urlencoded")) {
        const f = new br(),
          l = new URLSearchParams(await this.text());
        for (const [p, h] of l) f.append(p, h);
        return f;
      }
      const { toFormData: a } = await import("../multipart-parser.mjs");
      return a(this.body, o);
    }
    async blob() {
      const o =
        (this.headers && this.headers.get("content-type")) ||
        (this[H].body && this[H].body.type) ||
        "";
...
async function zn(i) {
  ...
  try {
    ...
    throw l instanceof ft
      ? l
      : new G(`Invalid response body while trying to fetch ${i.url}: ${l.message}`, "system", l);
  }
  if (o.readableEnded === !0 || o._readableState.ended === !0)
    try {
      return a.every((l) => typeof l == "string")
        ? Buffer$1.from(a.join(""))
        : Buffer$1.concat(a, f);
    } catch (l) {
      throw new G(
        `Could not create Buffer from response body for ${i.url}: ${l.message}`,
        "system",
        l,
      );
    }
...
const In = n$1((i, o) => {
    ...
    return (
      l instanceof me &&
        ...
        ((a = new PassThrough({ highWaterMark: o })),
        (f = new PassThrough({ highWaterMark: o })),
        l.pipe(a),
        l.pipe(f),
        (i[H].stream = a),
        (l = f)),
      ...
      i === null
        ...
        : typeof i == "string"
          ...
          : wi(i)
            ...
            : yr(i)
              ? i.type || null
              : Buffer$1.isBuffer(i) || types.isAnyArrayBuffer(i) || ArrayBuffer.isView(i)
                ? null
                : i instanceof br
                  ? `multipart/form-data; boundary=${o[H].boundary}`
                  : i && typeof i.getBoundary == "function"
                    ? `multipart/form-data;boundary=${tl(i)}`
                    : i instanceof me
                      ? null
                      : "text/plain;charset=UTF-8",
    "extractContentType",
  ...
  rl = n$1((i) => {
    ...
    return o === null
      ...
      : yr(o)
        ...
        : Buffer$1.isBuffer(o)
          ? o.length
          : o && typeof o.getLengthSync == "function" && o.hasKnownLength && o.hasKnownLength()
            ? o.getLengthSync()
            : null;
  }, "getTotalBytes"),
  nl = n$1(async (i, { body: o }) => {
    o === null ? i.end() : await el(o, i);
  }, "writeToStream"),
  gr =
    typeof Bt.validateHeaderName == "function"
      ? Bt.validateHeaderName
      : (i) => {
          if (!/^[\^`\-\w!#$%&'*+.|~]+$/.test(i)) {
            const o = /* @__PURE__ */ new TypeError(
              `Header name must be a valid HTTP token [${i}]`,
            );
            throw (Object.defineProperty(o, "code", { value: "ERR_INVALID_HTTP_TOKEN" }), o);
          }
        },
  Fn =
    typeof Bt.validateHeaderValue == "function"
      ? Bt.validateHeaderValue
      : (i, o) => {
          if (/[^\t\u0020-\u007E\u0080-\u00FF]/.test(o)) {
  ...
  Pr = class Pr extends URLSearchParams {
    constructor(o) {
      ...
      if (o instanceof Pr) {
        ...
        if (typeof o == "object" && !types.isBoxedPrimitive(o)) {
      ...
      return (
        (a =
          a.length > 0
            ? a.map(([f, l]) => (gr(f), Fn(f, String(l)), [String(f).toLowerCase(), String(l)]))
            : void 0),
        super(a),
        new Proxy(this, {
          get(f, l, p) {
            switch (l) {
              ...
              case "set":
                return (h, S) => (
                  gr(h),
                  Fn(h, String(S)),
                  URLSearchParams.prototype[l].call(f, String(h).toLowerCase(), String(S))
                );
              case "delete":
              case "has":
              case "getAll":
                return (h) => (
                  gr(h),
                  URLSearchParams.prototype[l].call(f, String(h).toLowerCase())
                );
              case "keys":
    ...
    forEach(o, a = void 0) {
      for (const f of this.keys()) Reflect.apply(o, a, [this.get(f), f, this]);
    }
    *values() {
...
Object.defineProperties(
  ye.prototype,
  ["get", "entries", "forEach", "values"].reduce((i, o) => ((i[o] = { enumerable: !0 }), i), {}),
);
function ol(i = []) {
  return new ye(
    i
      .reduce((o, a, f, l) => (f % 2 === 0 && o.push(l.slice(f, f + 2)), o), [])
      .filter(([o, a]) => {
        try {
...
const il = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]),
  jn = n$1((i) => il.has(i), "isRedirect"),
  se = Symbol("Response internals"),
  Ne = class Ne extends xe {
    constructor(o = null, a = {}) {
      super(o, a);
      const f = a.status != null ? a.status : 200,
        l = new ye(a.headers);
...
const al = n$1((i) => {
  ...
  const o = i.href.length - 1,
    a = i.hash || (i.href[o] === "#" ? "#" : "");
  return i.href[o - a.length] === "?" ? "?" : "";
}, "getSearch");
function Ti(i, o = !1) {
  return i == null || ((i = new URL(i)), /^(about|blob|data):$/.test(i.protocol))
    ? "no-referrer"
    : ((i.username = ""),
      (i.password = ""),
      (i.hash = ""),
...
function ul(i) {
  ...
  const o = i.host.replace(/(^\[)|(]$)/g, ""),
    a = isIP(o);
  return (a === 4 && /^127\./.test(o)) || (a === 6 && /^(((0+:){7})|(::(0+:){0,6}))0*1$/.test(o))
    ? !0
    : i.host === "localhost" || i.host.endsWith(".localhost")
      ? !1
      : i.protocol === "file:";
}
n$1(ul, "isOriginPotentiallyTrustworthy");
function ct(i) {
  return /^about:(blank|srcdoc)$/.test(i) ||
    i.protocol === "data:" ||
    /^(blob|filesystem):$/.test(i.protocol)
    ? !0
    : ul(i);
}
...
const $$1 = Symbol("Request internals"),
  qt = n$1((i) => typeof i == "object" && typeof i[$$1] == "object", "isRequest"),
  dl = deprecate(
    () => {},
    ".data is not a valid RequestInit property, use .body instead",
    "https://github.com/node-fetch/node-fetch/issues/1000 (request)",
  ),
  vr = class vr extends xe {
    constructor(o, a = {}) {
      let f;
      if (
        (qt(o) ? (f = new URL(o.url)) : ((f = new URL(o)), (o = {})),
        f.username !== "" || f.password !== "")
      )
        throw new TypeError(`${f} is an url with embedded credentials.`);
      let l = a.method || o.method || "GET";
      if (
        (/^(delete|get|head|options|post|put)$/i.test(l) && (l = l.toUpperCase()),
        !qt(a) && "data" in a && dl(),
        (a.body != null || (qt(o) && o.body !== null)) && (l === "GET" || l === "HEAD"))
      )
        throw new TypeError("Request with GET/HEAD method cannot have body");
      ...
      ((this[$$1] = {
        ...
        (this.follow = a.follow === void 0 ? (o.follow === void 0 ? 20 : o.follow) : a.follow),
        (this.compress =
          a.compress === void 0 ? (o.compress === void 0 ? !0 : o.compress) : a.compress),
        (this.counter = a.counter || o.counter || 0),
        (this.agent = a.agent || o.agent),
        (this.highWaterMark = a.highWaterMark || o.highWaterMark || 16384),
        (this.insecureHTTPParser = a.insecureHTTPParser || o.insecureHTTPParser || !1),
        (this.referrerPolicy = a.referrerPolicy || o.referrerPolicy || ""));
    }
    get method() {
...
const hl = n$1((i) => {
    const { parsedURL: o } = i[$$1],
      a = new ye(i[$$1].headers);
    ...
    (f && a.set("Content-Length", f),
      i.referrerPolicy === "" && (i.referrerPolicy = sl),
      i.referrer && i.referrer !== "no-referrer"
        ? (i[$$1].referrer = fl(i))
        : (i[$$1].referrer = "no-referrer"),
      i[$$1].referrer instanceof URL && a.set("Referer", i.referrer),
      a.has("User-Agent") || a.set("User-Agent", "node-fetch"),
      i.compress && !a.has("Accept-Encoding") && a.set("Accept-Encoding", "gzip, deflate, br"));
    let { agent: l } = i;
...
function pl() {
  ...
  if (((Pi = 1), !globalThis.DOMException))
    try {
      const { MessageChannel: i } = __require("worker_threads"),
        o = new i().port1,
        a = /* @__PURE__ */ new ArrayBuffer();
      o.postMessage(a, [a, a]);
    } catch (i) {
...
async function Ai(i, o) {
  return new Promise((a, f) => {
    const l = new dt(i, o),
      { parsedURL: p, options: h } = hl(l);
    if (!wl.has(p.protocol))
      throw new TypeError(
        `node-fetch cannot load ${i}. URL scheme "${p.protocol.replace(/:$/, "")}" is not supported.`,
      );
    if (p.protocol === "data:") {
      const g = Us(l.url);
    ...
    const S = (p.protocol === "https:" ? zs : Bt).request,
      { signal: v } = l;
    let w = null;
    const A = n$1(() => {
      const g = new _r("The operation was aborted.");
      (f(g),
        l.body && l.body instanceof me.Readable && l.body.destroy(g),
        !(!w || !w.body) && w.body.emit("error", g));
    }, "abort");
    if (v && v.aborted) {
      A();
      return;
    ...
    (b.on("error", (g) => {
      ...
      b.on("response", (g) => {
        ...
        if (jn(g.statusCode)) {
          ...
          try {
            ...
            if (l.redirect !== "manual") {
              (f(
                new G(
                  `uri requested responds with an invalid redirect URL: ${z}`,
                  "invalid-redirect",
                ),
              ),
                q());
          ...
          switch (l.redirect) {
            ...
            case "follow": {
              ...
              (g.statusCode === 303 ||
                ((g.statusCode === 301 || g.statusCode === 302) && l.method === "POST")) &&
            ...
            default:
              return f(
                /* @__PURE__ */ new TypeError(
                  `Redirect option '${l.redirect}' is not a valid value of RequestRedirect`,
                ),
              );
          }
        }
        ...
        if (Q === "deflate" || Q === "x-deflate") {
          ...
          (z.once("data", (j) => {
            ((j[0] & 15) === 8
              ? (I = pipeline(I, st.createInflate(), (U) => {
                  U && f(U);
                }))
  ...
  (i.on("response", (h) => {
    ...
    i.on("socket", (h) => {
      const S = n$1(() => {
        ...
        v = n$1((w) => {
          ((l = Buffer$1.compare(w.slice(-5), a) === 0),
            !l &&
              p &&
              (l =
                Buffer$1.compare(p.slice(-3), a.slice(0, 3)) === 0 &&
                Buffer$1.compare(w.slice(-2), a.slice(3)) === 0),
            (p = w));
        }, "onData");
      (h.prependListener("close", S),
        h.on("data", v),
        i.on("close", () => {
...
function ki(i) {
  ...
  i.event.cancelable &&
    ((i.canceled = !0), typeof i.event.preventDefault == "function" && i.event.preventDefault());
}
...
(n$1(ht, "Event"),
  (ht.prototype = {
    ...
    stopImmediatePropagation() {
      const i = W(this);
      ((i.stopped = !0),
        (i.immediateStopped = !0),
        typeof i.event.stopImmediatePropagation == "function" &&
  ...
  typeof window < "u" &&
    ...
    (Object.setPrototypeOf(ht.prototype, window.Event.prototype),
    Dn.set(window.Event.prototype, ht)));
function Wi(i) {
  return {
    get() {
...
function Li(i) {
  ...
  (n$1(o, "CustomEventTarget"),
    (o.prototype = Object.create(Pe.prototype, {
      constructor: {
        value: o,
        configurable: !0,
        writable: !0,
...
(n$1(Pe, "EventTarget"),
  (Pe.prototype = {
    addEventListener(i, o, a) {
      if (o == null) return;
      if (typeof o != "function" && !Rr(o))
        throw new TypeError("'listener' should be a function or an object.");
      const f = Ot(this),
        l = Rr(a),
        h = (l ? !!a.capture : !!a) ? Ii : Fi,
        S = {
          listener: o,
          listenerType: h,
          passive: l && !!a.passive,
    ...
    dispatchEvent(i) {
      ...
      for (; f != null; ) {
        if (
          (f.once
            ? p !== null
              ...
              : f.next !== null
                ...
                : o.delete(a)
            : (p = f),
          Oi(l, f.passive ? f.listener : null),
          typeof f.listener == "function")
        )
          try {
          ...
          f.listenerType !== wr &&
            typeof f.listener.handleEvent == "function" &&
            f.listener.handleEvent(l);
        if (vl(l)) break;
        f = f.next;
      }
  ...
  typeof window < "u" &&
    ...
    Object.setPrototypeOf(Pe.prototype, window.EventTarget.prototype));
...
(Object.defineProperties(pt.prototype, { aborted: { enumerable: !0 } }),
...
function Di(i) {
  ...
  if (o == null)
    throw new TypeError(
      `Expected 'this' to be an 'AbortController' object, but got ${i === null ? "null" : typeof i}`,
    );
  return o;
}
(n$1(Di, "getSignal"),
...
function stringifyParsedURL(parsed) {
  ...
  return (
    (parsed.protocol || parsed[protocolRelative] ? (parsed.protocol || "") + "//" : "") +
    auth +
    host +
    pathname +
    search +
...
function createFetchError(ctx) {
  ...
  const fetchError = new FetchError(
    `${`[${method}] ${JSON.stringify(url)}`}: ${ctx.response ? `${ctx.response.status} ${ctx.response.statusText}` : "<no response>"}${errorMessage ? ` ${errorMessage}` : ""}`,
...
const retryStatusCodes = /* @__PURE__ */ new Set([408, 409, 425, 429, 500, 502, 503, 504]);
  ...
  F = class F {
    constructor(a) {
      ((this.index = 0),
        (this.flags = 0),
        (this.onHeaderEnd = m),
        (this.onHeaderField = m),
        (this.onHeadersEnd = m),
        (this.onHeaderValue = m),
        (this.onPartBegin = m),
        (this.onPartData = m),
        (this.onPartEnd = m),
        (this.boundaryChars = {}),
...
--` + a));
      ...
      for (let r = 0; r < a.length; r++)
        ((n[r] = a.charCodeAt(r)), (this.boundaryChars[n[r]] = !0));
      ((this.boundary = n),
        (this.lookbehind = new Uint8Array(this.boundary.length + 8)),
        (this.state = t.START_BOUNDARY));
    }
    write(a) {
      let n = 0;
      const r = a.length;
      let d = this.index,
        { lookbehind: l, boundary: c, boundaryChars: p, index: e, state: i, flags: A } = this;
      const H = this.boundary.length,
        O = H - 1,
        y = a.length;
      let o, L;
      const f = E((h) => {
        ...
        b = E((h, S) => {
          ...
          _ in this &&
            (S
              ? (T(h, this[_], n, a), delete this[_])
              : (T(h, this[_], a.length, a), (this[_] = 0)));
        }, "dataCallback");
      for (n = 0; n < r; n++)
        switch (((o = a[n]), i)) {
      ...
      if (
        (this.state === t.HEADER_FIELD_START && this.index === 0) ||
        (this.state === t.PART_DATA && this.index === this.boundary.length)
      )
        this.onPartEnd();
...
function v(u) {
  ...
  return (
    (r = r.replace(/%22/g, '"')),
    (r = r.replace(/&#(\d{4});/g, (d, l) => String.fromCharCode(l))),
    r
  );
}
E(v, "_fileName");
