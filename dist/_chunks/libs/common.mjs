...
var { toStringTag: Wt, iterator: Qs, hasInstance: Ys } = Symbol, _i = Math.random, Gs = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), Si = n$1((i, o, a) => (i += "", /^(Blob|File)$/.test(o && o[Wt]) ? [(a = a !== void 0 ? a + "" : o[Wt] == "File" ? o.name : "blob", i), o.name !== a || o[Wt] == "blob" ? new qn([o], a, o) : o] : [i, o + ""]), "f"), On = n$1((i, o) => (o ? i : i.replace(/\r?\n|\r/g, `\r
...
const $$1 = Symbol("Request internals"), qt = n$1((i) => typeof i == "object" && typeof i[$$1] == "object", "isRequest"), dl = deprecate(() => {}, ".data is not a valid RequestInit property, use .body instead", "https://github.com/node-fetch/node-fetch/issues/1000 (request)"), vr = class vr extends xe {
	constructor(o, a = {}) {
		let f;
...
const hl = n$1((i) => {
	const { parsedURL: o } = i[$$1], a = new ye(i[$$1].headers);
	...
	f && a.set("Content-Length", f), i.referrerPolicy === "" && (i.referrerPolicy = sl), i.referrer && i.referrer !== "no-referrer" ? i[$$1].referrer = fl(i) : i[$$1].referrer = "no-referrer", i[$$1].referrer instanceof URL && a.set("Referer", i.referrer), a.has("User-Agent") || a.set("User-Agent", "node-fetch"), i.compress && !a.has("Accept-Encoding") && a.set("Accept-Encoding", "gzip, deflate, br");
	let { agent: l } = i;
...
const ml = f(pl()), { stat: $n } = promises$1;
...
const vi = n$1((i, o, a = "") => new ut([new Sr({
	path: o,
	size: i.size,
