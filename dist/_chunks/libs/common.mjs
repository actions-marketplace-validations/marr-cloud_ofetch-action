...
const mr = Symbol.toStringTag,
  ...
  Nn = class Nn {
    ...
    async formData() {
      ...
      const { toFormData: a } = await Promise.resolve().then(() => multipart_parser_exports);
...
function ul(i) {
  ...
  const o = i.host.replace(/(^\[)|(]$)/g, ""),
    a = isIP(o);
  return (a === 4 && o.startsWith("127.")) ||
    (a === 6 && /^(((0+:){7})|(::(0+:){0,6}))0*1$/.test(o))
    ? !0
...
var multipart_parser_exports = /* @__PURE__ */ __exportAll({ toFormData: () => Z });
